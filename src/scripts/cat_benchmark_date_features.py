...
if __name__ == "__main__":
    ...
    results_dict_co = model.cat_train_validate_on_holdout(
        logger=logger,
        run_id=RUN_ID,
        ...
        cat_features=date_features,
        label_name="co",
        log_target=False,
    )

    results_dict_benzene = model.cat_train_validate_on_holdout(
        logger=logger,
        run_id=RUN_ID,
        training=training_df,
        validation=validation_df,
    ...
    results_dict_no = model.cat_train_validate_on_holdout(
        logger=logger,
        run_id=RUN_ID,
        training=training_df,
        validation=validation_df,
