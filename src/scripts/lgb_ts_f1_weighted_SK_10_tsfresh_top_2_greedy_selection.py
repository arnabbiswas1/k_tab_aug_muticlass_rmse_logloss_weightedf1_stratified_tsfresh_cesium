...
if __name__ == "__main__":
    ...
    logger.info(f"results_dict_copy[prediction] {len(results_dict_copy['prediction'])}")
    logger.info(f"results_dict_copy[prediction] {results_dict_copy['prediction']}")
    logger.info(sample_submission_df.shape)
    logger.info(sample_submission_df.head())
    logger.info(sample_submission_df.columns)
